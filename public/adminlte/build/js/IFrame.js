...
const SELECTOR_SIDEBAR_MENU_ITEM = '.main-sidebar .nav-admin > a.nav-link'
const SELECTOR_SIDEBAR_SEARCH_ITEM = '.sidebar-search-results .list-group-admin'
const SELECTOR_HEADER_MENU_ITEM = '.main-header .nav-admin a.nav-link'
const SELECTOR_HEADER_DROPDOWN_ITEM = '.main-header a.dropdown-admin'
...
class IFrame {
  ...
  removeActiveTab(type, element) {
    if (type == 'all') {
      ...
      const $navItem = $navClose.parent('.nav-admin')
