...
/**
 * Resembles an admin in the grid of Filterizr.
 */
export default class FilterItem {
    ...
    /**
     * Helper method to calculate the animation delay for a given grid admin
     * @param delay in ms
     ...
     * @return {String[]} an array of the categories the admin belongs to
     */
