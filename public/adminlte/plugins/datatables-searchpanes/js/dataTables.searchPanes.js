...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            var t0;
            // When an admin is selected on the pane, add these to the array which holds selected items.
            ...
            // When an admin is deselected on the pane, re add the currently selected items to the array
        ...
        SearchPane.prototype._reloadSelect = function (loadedFilter) {
            ...
            // find the id of each search admin and set it to be selected.
            for (var i = 0; i < loadedFilter.searchPanes.panes.length; i++) {
                if (loadedFilter.searchPanes.panes[i].id === this.s.index) {
                    idx = i;
                    break;
        ...
        SearchPane.prototype._search = function (filter, dataIndex) {
            var colOpts = this.s.colOpts;
            var table = this.s.dt;
            // For each admin selected in the pane, check if it is available in the cell
