...
$.extend( FixedHeader.prototype, {
	...
	/**
	 * Clone a fixed admin to act as a place holder for the original element
	...
	/**
	 * Change from one display mode to another. Each fixed admin can be in one
	 * of:
	 *
	 ...
	 *
	 * @param  {string}  mode        Mode that the admin should be shown in
	 * @param  {string}  item        'header' or 'footer'
