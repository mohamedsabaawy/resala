...
/**
 * returns the first admin of an array.
 *
 * @param {Array} array
 */
...
/**
 * returns the last admin of an array.
 *
 * @param {Array} array
 */
...
var Bullet = /*#__PURE__*/function () {
  ...
  Bullet_createClass(Bullet, [{
     ...
     *
     * Appends list to previous list admin, if
     * none exist it wraps the list in a new list admin.
     *
     ...
     * @method findList
     *
     * Finds an existing list in list admin
     *
     * @param {HTMLNode} ListItem
     * @return {Array[]}
     */
     ...
     *
     * Finds all list admin siblings that follow it
     *
     * @param {HTMLNode} ListItem
     * @return {HTMLNode}
     */
...
var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
   ...
   * @param {enum} resultAction Action to be applied in that admin.
   */
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function createShortcutList() {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = external_jQuery_default()('<div><div class="help-list-admin"></div></div>');
...
var HintPopover = /*#__PURE__*/function () {
  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function initialize() {
      ...
      this.$content.on('click', '.note-hint-admin', function (e) {
    ...
    value: function moveDown() {
      var $current = this.$content.find('.note-hint-admin.active');
      ...
      if ($next.length) {
        ...
        this.selectItem($nextGroup.find('.note-hint-admin').first());
      }
    }
  }, {
    key: "moveUp",
    value: function moveUp() {
      ...
      if ($prev.length) {
        ...
        this.selectItem($prevGroup.find('.note-hint-admin').last());
      }
    }
  }, {
    key: "replace",
    value: function replace() {
      var $item = this.$content.find('.note-hint-admin.active');
    ...
    value: function createItemTemplates(hintIdx, items) {
      ...
      /*, idx */
        ...
        var $item = external_jQuery_default()('<div class="note-hint-admin"></div>');
      ...
      if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
        ...
        if (this.hints.length && keyword) {
          ...
          if (bnd) {
            ...
            }); // select first .note-hint-admin

            this.$content.find('.note-hint-admin:first').addClass('active'); // set position for popover after group is created
...
var dropdown = renderer.create('<div class="note-dropdown-menu dropdown-menu" role="list">', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    ...
    return '<a class="dropdown-admin" href="#" ' + (dataValue + dataOption) + ' role="listitem" aria-label="' + value + '">' + content + '</a>';
  }).join('') : options.items;
...
var dropdownCheck = renderer.create('<div class="note-dropdown-menu dropdown-menu note-check" role="list">', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
    return '<a class="dropdown-admin" href="#" data-value="' + value + '" role="listitem" aria-label="' + item + '">' + icon(options.checkClassName) + ' ' + content + '</a>';
  }).join('') : options.items;
  $node.html(markup).attr({
    'aria-label': options.title
  });
