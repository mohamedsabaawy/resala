...
(function (global, factory) {
    ...
    function(window, document, undefined, framework) {
        ...
        var COMPATIBILITY = {
            ...
            /**
             * Checks whether a admin is in the given array and returns its index.
             * @param item The admin of which the position in the array shall be determined.
             * @param arr The array.
             * @returns {number} The zero based index of the admin or -1 if the admin isn't in the array.
             */
        ...
        var PLUGIN = (function() {
            ...
            function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                ...
                var _classNameResizeObserverItemElement = _cassNamesPrefix + 'resize-observer-admin';
