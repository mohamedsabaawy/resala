        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @forelse($maritalStatuses as $maritalStatus)
                <tr class="{{$maritalStatus->deleted_at ? 'bg-gradient-gray':''}}">
                    ...
                    <td>
                        <div class="btn-group">
                            @can('maritalStatus delete')
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target="#delete-model"
                                        wire:click="show({{$maritalStatus->id}})"><i class="fa fa-trash"></i>مسح
                                </button>
                            @endcan
                            @can('maritalStatus edit')
                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                        data-target="#create-model" wire:click="show({{$maritalStatus->id}})"><i
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                               ...
                               placeholder="ادخل اسم الحالة اجتماعية">
