                        ...
                        <div class="btn-group">
                            @can('degree delete')
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target="#delete-model" wire:click="show({{$degree->id}})"><i
                                        class="fa fa-trash"></i>مسح
                                </button>
                            @endcan
                            @can('degree edit')
                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                        data-target="#create-model" wire:click="show({{$degree->id}})"><i
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                               ...
                               placeholder="ادخل اسم الدرجة تطوع">
