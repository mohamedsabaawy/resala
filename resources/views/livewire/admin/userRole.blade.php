        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">{{$isUpdate ? "تعديل مستخدم" :"انشاء مستخدم جديد"}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="custom-content-below-team-tab" data-toggle="pill"
                                   href="#custom-content-below-team" role="tab"
                                   aria-controls="custom-content-below-team" aria-selected="false">صلاحيات اللجان</a>
                            </li>
                        </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 text-center">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label for="main-menu-show" class="custom-control-label">عرض ادارة
                                                الهيكل</label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tab-content" id="vert-tabs-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="vert-tabs-role" role="tabpanel"
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label for="role-menu-show" class="custom-control-label">عرض ادارة
                                                        الصلاحيات</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 text-center">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label for="user-menu-show" class="custom-control-label">عرض قائمة ادارة
                                                المتطوعين</label>
                                        </div>
                                    </div>
                                    <div class="col-7 col-sm-6">
