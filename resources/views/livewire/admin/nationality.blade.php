        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @forelse($nationalities as $nationality)
                <tr class="{{$nationality->deleted_at ? 'bg-gradient-gray':''}}">
                    ...
                    <td>
                        <div class="btn-group">
                            @can('nationality delete')
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target="#delete-model"
                                        wire:click="show({{$nationality->id}})"><i class="fa fa-trash"></i>مسح
                                </button>
                            @endcan
                            @can('nationality edit')
                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                        data-target="#create-model" wire:click="show({{$nationality->id}})"><i
