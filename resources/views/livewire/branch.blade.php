        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @forelse($branches as $branch)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-model" wire:click="show({{$branch->id}})" >مسح</button>
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#create-model" wire:click="show({{$branch->id}})">تعديل</button>
                        </div>
                    </td>
                </tr>
            @empty
